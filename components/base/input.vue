<template>
    <div class="input__wrapper">
        <div class="input__inner">
            <input
                :class="{ input: true, password: password, incorrect: errorType > 0, correct: correct}"
                :type="inputType"
                id="name"
                name="name"
                required
            ...
            />
            <img class="input__img" :src="imgSrc" alt=""
            v-if="password"
  ...
  export default {
    ...
    data() {
      return {
        errors: [
          "",
          "This email is invalid. Please check it and try again.",
          "Seems this password is wrong. Please try again.",
          "This doesn’t seem a real name. Please try again.",
          "Seems your passwords do not match",
        ],
        inputType: this.password ? "password" : "text",
        imgSrc: "../../assets/icons/opened_eye.svg"
      };
    },
    methods: {
      toggleInputType() {
        ...
        this.imgSrc =
        this.imgSrc === "../../assets/icons/opened_eye.svg"
